...
async def generate_report_markdown(
    ...
    system_prompt = (
        ...
        "## Überblick\n"
        "Welche Gesetze wurden geändert, was sind die Neuerungen.\n\n"
        "## [Titel — NUR basierend auf den gelieferten Daten]\n"
        ...
        "- WER ist betroffen\n"
        "5-8 Sätze pro Abschnitt. NUR auf Basis der gelieferten Daten.\n\n"
        "## Ausblick\n"
